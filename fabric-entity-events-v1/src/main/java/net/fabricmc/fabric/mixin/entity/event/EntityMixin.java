...
abstract class EntityMixin {
	...
	private boolean handleCustomFluidInteractionUpdates(boolean original) {
		return EntityFluidEvents.ON_FLUID_INTERACTION_UPDATE.invoker().onFluidInteractionUpdate((Entity) (Object) this, this.fluidInteraction, this.isPushedByFluid()) || original;
	}
}
